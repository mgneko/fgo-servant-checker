const app = (function() {
    ...
    const campaigns = {
        ...
        'tw_lostbelt_clear': {
            name: '【台GO】第2部通關應援福袋召喚',
            type: 'custom',
            groups: {
                // === 紅組 (女性) ===
                '紅組-全體 (劍弓槍)': [270, 234, 276, 272, 280, 253, 241, 284, 237, 239, 247, 261, 265, 229, 250, 268, 238, 285, 289, 281, 275]
            }
        },
        
        // --- 台版 2025 新年福袋 (對應日版 2024 新年) ---
        // 形式：男女區別 × 職階分組 × 寶具類型
        // 註：為方便檢視，這裡將部分詳細分組整合為大類
        'tw_2025_ny': {
            name: '【台GO】2025 新年 (男女×寶具類型)',
            type: 'custom',
            groups: {
                // === 紅組 (女性) ===
                '紅組-全體 (劍弓槍)': [2, 8, 76, 90, 160, 270, 299, 317, 337, 12, 60, 77, 84, 129, 212, 350, 119, 128, 196, 232, 280, 300, 312], 
                '紅組-單體 (劍弓槍)': [68, 91, 153, 213, 223, 234, 278, 302, 142, 156, 216, 276, 70, 85, 88, 143, 312, 329],
                '紅組-全體 (騎術殺狂)': [108, 144, 206, 241, 274, 296, 331, 342, 127, 136, 169, 175, 201, 327, 139, 154, 239, 314, 365, 98, 155, 261, 309, 355],
                '紅組-單體/輔助 (騎術殺狂)': [65, 99, 118, 179, 205, 253, 277, 37, 62, 113, 150, 215, 237, 284, 307, 75, 86, 112, 154, 189, 199, 235, 51, 52, 97, 114, 161, 226, 247, 306],
                '紅組-全體 (EXTRA)': [96, 106, 163, 209, 238, 250, 275, 303, 316, 339, 346, 59, 173, 195, 224, 229, 244, 265, 268, 281, 297, 321],
                '紅組-單體/輔助 (EXTRA)': [93, 167, 198, 220, 268, 285, 289, 305, 334, 351, 353, 106, 250, 292, 295, 324, 336, 356, 357],
                
                // === 白組 (男性/其他) ===
                '白組-全體 (三騎士)': [272, 383, 394, 427, 368, 381, 433], 
                '白組-單體 (三騎士)': [156, 276, 193, 214, 217],
                '白組-全體 (四騎士)': [211, 263, 315, 326, 366, 387, 401, 319, 340, 358, 404, 360, 361, 378, 408],
                '白組-單體/輔助 (四騎士)': [132, 182, 322, 103, 120, 145, 192, 194, 208, 225, 236, 133, 159, 170, 177, 185, 188, 218, 230, 48, 58, 82, 89, 116],
                '白組-EXTRA': [135, 233, 242, 320, 364, 147, 158, 328, 388, 420, 164, 190, 191, 338, 451]
            }
        },

        // --- 日版 10 週年福袋 (2025) ---
        // 形式：職階區別 × 寶具效果區別 (單體/全體/輔助)
        'jp_10th_anni': {
            name: '【日GO】10週年福袋 (職階×寶具分類)',
            type: 'custom',
            groups: {
                '劍職 (全體寶具)': [2, 8, 76, 90, 160, 270, 299, 317, 337],
                '劍職 (單體/輔助)': [68, 91, 153, 213, 223, 234, 278, 302],
                '弓職 (全體寶具)': [12, 60, 77, 84, 129, 212, 272, 350, 383, 394],
                '弓職 (單體/輔助)': [142, 156, 216, 276, 427],
                '槍職 (全體寶具)': [119, 128, 196, 232, 280, 300, 312, 368, 381, 433],
                '槍職 (單體/輔助)': [70, 85, 88, 143, 312, 329, 193, 214, 217],
                '騎職 (全體寶具)': [108, 144, 206, 241, 274, 296, 331, 342, 211, 263, 315, 326],
                '騎職 (單體/輔助)': [65, 99, 118, 179, 205, 253, 277, 132, 182, 322],
                '術職 (全體寶具)': [127, 136, 169, 175, 201, 327, 319, 340, 358],
                '術職 (單體/輔助)': [37, 62, 113, 150, 215, 237, 284, 307, 103, 120, 145, 192, 194],
                '殺職 (全體寶具)': [139, 154, 239, 314, 365, 360, 361, 378, 408],
                '殺職 (單體/輔助)': [75, 86, 112, 154, 189, 199, 235, 133, 159, 170, 177],
                '狂職 (全體寶具)': [98, 155, 261, 309, 355],
                '狂職 (單體/輔助)': [51, 52, 97, 114, 161, 226, 247, 306, 48, 58, 82, 89],
                'EXTRA (Quick寶具)': [96, 106, 163, 209, 238, 250, 275, 303, 316, 339, 346, 147, 158, 328],
                'EXTRA (Arts寶具)': [59, 173, 195, 224, 229, 244, 265, 268, 281, 297, 321, 135, 233, 242],
                'EXTRA (Buster寶具)': [93, 167, 198, 220, 268, 285, 289, 305, 334, 351, 353, 106, 250, 292]
            }
        }
    };
    ...
    // ==========================================
    // 5. 截圖功能 (Screenshot - v9.4 修正間距與縮放)
    // ==========================================
    function generateImage() {
        ...
        styleReset.innerHTML = `
            ...
            /* ★ 修正：大幅縮小截圖時的垂直間距 */
            .class-section { margin-bottom: 2px !important; margin-top: 2px !important; }
            .class-header { margin-bottom: 2px !important; }
            ...
            .servant-grid { 
                ...
                padding-bottom: 10px !important; /* 底部縫隙縮小 */
            }
